...
class MainPage(tk.Frame):
    def __init__(self, parent, controller):
        ...
        self.on_cell_detection = ttk.Button(
            self, text="ON", command=self.popup_cell_detection
        )
        ...
        self.start_capture = ttk.Button(
            self, text="Start Capture", command=self.capture_start
        )
        self.start_capture.grid(row=3, column=2, padx=10, pady=10)

        self.stop_capture = ttk.Button(
            self, text="Stop Capture", command=self.capture_stop
        )
        ...
        self.duration = ttk.OptionMenu(
            self, self.duration_var, "20ms", "50ms", "100ms", "200ms"
        )
    ...
    def popup_cell_detection(self):
        ...
        version = ttk.OptionMenu(
            win, version_var, "YOLOv3", "YOLOv4", "YOLOv5", "PP-YOLO"
        )
        ...
        detection = ttk.OptionMenu(
            win, detection_var, "Single Detection", "Tracking", "Multiple Detection"
        )
