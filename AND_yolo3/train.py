...
def _main():
    # Load paths ---------------------------------
    if lab_comp == True:
        annotation_path = "C:/Users/myip7/AND_Project_MG/AND_Project/2020_train.txt"
        log_dir = "C:/Users/myip7/AND_Project_MG/AND_Project/AND_yolo3/logs/001/"
        ...
        annotation_path = (
            "C:/Users/might/Documents/GitHub/AND_Project/keras-yolo3/2020_train.txt"
        )
        log_dir = "logs/000/"
    ...
    if is_tiny_version:
        model = create_tiny_model(
            ...
            num_classes,
            freeze_body=2,
            weights_path="AND_yolo3/model_data/tiny_yolo_weights.h5",
        )
    else:
        model = create_model(
            input_shape,
            ...
            num_classes,
            freeze_body=2,
            weights_path="AND_yolo3/model_data/trained_weights_stage_1.h5",
    ...
    if True:
        ...
        batch_size = (
            8  # note that more GPU memory is required after unfreezing the body
        )
        print(
            "Train on {} samples, val on {} samples, with batch size {}.".format(
                num_train, num_val, batch_size
